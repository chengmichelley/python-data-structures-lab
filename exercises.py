...
def combine_foods():
    foods = ("sushi", "mango", "avocado")
    meal = ""

    for food in foods:
        meal += "".join([food, " "])

    return foods, meal.strip()
...
# Call the function and print the result
print("Exercise 3:", slice_foods(combine_foods()[0]))
...
def hometown_info():
    home_town = {"city": "Boston", "state": "Massachusetts", "population": 13791391}
...
# Call the function and print the result
print("Exercise 5:", list_home_town_items(hometown_info()[0]))
